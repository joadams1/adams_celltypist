...
def get_all_predictions(adata_loc, models_loc, write_loc):
    ...
    '''
    model_loc_6_4000 = models_loc+ "6_4000.pkl"
    write_loc_6_4000 = write_loc + "6_4000.h5ad"
    pred_6_4000 = get_predictions(adata_loc, model_loc_6_4000, write_loc_6_4000)
    pred_6_4000.obs["model"] = 7
    print("model 6 done")
    '''
...
#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/CT_98_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/CT_98 Models/98_f_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_98_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/COV_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/COV_PBMC Models/COV_f_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_COV_model')
    
#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/train_glas.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Glasner Models/g_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_g_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/train_glas.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Glasner Models/g_alt_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_g_alt_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/HBCA_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/HBCA Models/HBCA_f_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_HBCA_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/LuCA_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/LuCA Models/LuCA_f_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_LuCA_prob_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/HuBMAP_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/HuBMAP Models/HuBMAP_f_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_HuBMAP_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/Niec_SI_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Niec Models/Niec_SI_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_Niec_SI_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/Niec_LI_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Niec Models/Niec_LI_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_Niec_LI_model')

#get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/Brown_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Brown Models/Brown_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_Brown_model')

get_all_predictions('/data/peer/adamsj5/cell_typing/train_test_data/Cheong_Test.h5ad', '/home/adamsj5/auto_cell_typing/celltypist/New Models/Cheong Models/Cheong_model_', '/data/peer/adamsj5/cell_typing/Data with Predictions/pred_Cheong_model')
