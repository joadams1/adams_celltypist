...
def make_final_model(adata_loc, annot_col, abrev, write_loc, genes_check,  n_genes: int = 10000):
'''
Function to make one CellTypist model using only 
'''
